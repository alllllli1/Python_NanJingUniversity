...
#出现错误：bs4.FeatureNotFound: Couldn't find a tree builder with the features you requested: lxml. Do you need
#解决方案：Terminal使用命令： pip install lxml
  #下面是在Python Console处的命令和答案
